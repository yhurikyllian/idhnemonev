...
var BFHStatesList = {
  ...
  'ID':{
    '1' : {'code':'Daista Aceh','name':'Daista Aceh'},
    '2' : {'code':'Sumatera Utara','name':'Sumatera Utara'},
    '3' : {'code':'Sumatera Barat','name':'Sumatera Barat'},
    '4' : {'code':'Riau','name':'Riau'},
    '5' : {'code':'Jambi','name':'Jambi'},
    '6' : {'code':'Sumatera Selatan','name':'Sumatera Selatan'},
    '7' : {'code':'Bengkulu','name':'Bengkulu'},
    '8' : {'code':'Lampung','name':'Lampung'},
    '9' : {'code':'Dki Jakarta','name':'Dki Jakarta'},
    '10' : {'code':'Jawa Barat','name':'Jawa Barat'},
    '11' : {'code':'Jawa Tengah','name':'Jawa Tengah'},
    '12' : {'code':'Daista Yogyakarta','name':'Daista Yogyakarta'},
    '13' : {'code':'Jawa Timur','name':'Jawa Timur'},
    '14' : {'code':'Kalimantan Barat','name':'Kalimantan Barat'},
    '15' : {'code':'Kalimantan Tengah','name':'Kalimantan Tengah'},
    '16' : {'code':'Kalimantan Timur','name':'Kalimantan Timur'},
    '17' : {'code':'Kalimantan Selatan','name':'Kalimantan Selatan'},
    '18' : {'code':'Bali','name':'Bali'},
    '19' : {'code':'Nusa Tenggara Barat','name':'Nusa Tenggara Barat'},
    '20' : {'code':'Nusa Tenggara Timur','name':'Nusa Tenggara Timur'},
    '21' : {'code':'Sulawesi Selatan','name':'Sulawesi Selatan'},
    '22' : {'code':'Sulawesi Tengah','name':'Sulawesi Tengah'},
    '23' : {'code':'Sulawesi Utara','name':'Sulawesi Utara'},
    '24' : {'code':'Sulawesi Tenggara','name':'Sulawesi Tenggara'},
    '25' : {'code':'Maluku','name':'Maluku'},
    '26' : {'code':'Maluku Utara','name':'Maluku Utara'},
    '27' : {'code':'Irian Jaya Timur','name':'Irian Jaya Timur'},
    '28' : {'code':'Irian Jaya Tengah','name':'Irian Jaya Tengah'},
    '29' : {'code':'Irian Jaya Barat','name':'Irian Jaya Barat'},
    '30' : {'code':'Banten','name':'Banten'},
    '31' : {'code':'Bangka Belitung','name':'Bangka Belitung'},
    '32' : {'code':'Gorontalo','name':'Gorontalo'}
