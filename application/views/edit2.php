                  ...
                  <div class="" role="tabpanel" data-example-id="togglable-tabs">
                      ...
                      <div id="myTabContent" class="tab-content">
                        <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                           ...
                           <table id="tes" class="table table-striped table-bordered" style="table-layout: fixed;">
                              <thead>
                                <tr>
                                <th>Edit</th>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                           <table id="tes3" class="table table-striped table-bordered" style="table-layout: fixed;">
                              <thead>
                                <tr>
                                <th>Edit</th>
                                <?php 
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab_content3" aria-labelledby="profile-tab">
                           <table id="tes2" class="table table-striped table-bordered" style="table-layout: fixed;">
                              <thead>
                                <tr>
                                <th>Edit</th>
                                <?php 
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab_content4" aria-labelledby="profile-tab">
                           <table id="tes4" class="table table-striped table-bordered" style="table-layout: fixed;"s>
                              <thead>
                                <tr>
                                <th>Edit</th>
                                <?php 
