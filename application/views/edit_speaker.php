        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>EDIT SPEAKER <small></small></h2>
                ...
                <div class="x_content">
                  ...
                  <?php echo form_open_multipart('edit/update_speaker/'.$data[0]['id_speaker'], 'class="form-horizontal form-label-left"');?>
                  <!-- <form class="form-horizontal form-label-left" action="<?php echo base_url();?>index.php/addspeaker/addspeaker" method="post" novalidate> -->
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input value="<?php echo $data[0]['after_name'] ?>" type="text" id="email" name="title_a" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div>
                          ...
                          <textarea class="form-control" rows="4" name="resume"><?php echo $data[0]['resume'] ?></textarea>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input value="<?php echo $data[0]['shortbio'] ?>" type="text" id="email" name="short_bio" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>  
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div>
                          ...
                          <textarea class="form-control" rows="4" name="bio"><?php echo $data[0]['bio'] ?></textarea>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div>
                          ...
                          <textarea class="form-control" rows="2" name="address"><?php echo $data[0]['address'] ?></textarea>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div>
                          ...
                          <textarea class="form-control" rows="2" name="phone"><?php echo $data[0]['phone'] ?></textarea>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input value="<?php echo $data[0]['email'] ?>" type="text" id="email" name="email_speaker" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div> 
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input value="<?php echo $data[0]['expertise'] ?>" type="text" id="email" name="foe" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>  
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div>
                          ...
                          <select id="testing" class="form-control bfh-states" data-country="countries_states1" name="province" onchange="tes123()"></select>
