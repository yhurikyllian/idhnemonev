...
<head>
    ...
    <link href="<?php echo base_url()."assets/"?>css/city-picker.css" rel="stylesheet">
...
<script src="<?php echo base_url()."assets/"?>js/city-picker.data.js"></script>
<script src="<?php echo base_url()."assets/"?>js/city-picker.js"></script>
