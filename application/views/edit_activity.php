        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2> Edit Activity <small></small></h2>
                ...
                <div class="x_content">
                  ...
                  <?php echo form_open_multipart('edit/update_activity/'.$data[0]['activity_code'], 'class="form-horizontal form-label-left"');?>
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12" >
                      <select id="project_year1" class="form-control" name="project_year" onchange="gantiyear()">
                        <?php for($i = 0; $i<count($title); $i++) { 
                          if($title[$i] == $data[0]['project_title']){
                            foreach($year[$i] as $d){
                          if($data[0]['project_year'] == $d['project_year']){
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="email" name="activity_code" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $data[0]['activity_code'] ?>">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input value="<?php echo $data[0]['activity_name'] ?>" type="text" id="email" name="activity_name" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div>
                          ...
                          <textarea value="<?php echo $data[0]['venue'] ?>" class="form-control" required="required" rows="3" name="venue_address"><?php echo $data[0]['venue'] ?></textarea>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <?php $activityType = array ("Training", "Workshop", "Fieldwork or applied experience", "Meeting", "Seminar or Lecture", "Community outreach", "Advocacy or policy engagement", "Curriculum or course development", "Communication or media development"," Other"); 
                          ...
                          $checkbox = explode("; ", $data[0]["activity_type"]);
                          // print_r($checkbox);
                          ...
                          if(in_array($d,$checkbox)){
                              ?>
                          <div class="checkbox">
                            <label>
                              <input checked type="checkbox" name="activityType[]" value="<?php echo $d; ?>"> <?php echo $d; ?>
                            </label>
                          </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <?php $TargetAudience = array ("General public", "Student","Faculty members and teachers","Researchers and scientist", "Government officials","Other"); 
                          ...
                          $checkbox = explode("; ", $data[0]["target_audience"]);
                          // print_r($checkbox);
                          ...
                          <div class="checkbox">
                            <label>
                              <input checked type="checkbox" name="targetAudience[]" value="<?php echo $d; ?>"> <?php echo $d; ?>
                            </label>
                          </div>
                     ...
                     <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div>
                          ...
                          <textarea class="form-control" rows="2" name="activity_desc"><?php echo $data[0]['activity_description'] ?></textarea>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div>
                          ...
                          <textarea class="form-control" rows="2" name="objective"><?php echo $data[0]['objectives'] ?></textarea>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div>
                          ...
                          <textarea class="form-control" rows="2" name="anticipated_output"><?php echo $data[0]['output'] ?></textarea>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div>
                          ...
                          <textarea class="form-control" rows="2" name="anticipated_outcame"><?php echo $data[0]['outcomes'] ?></textarea>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div>
                          ...
                          <textarea class="form-control" rows="2" name="local_expertise"><?php echo $data[0]['expertise'] ?></textarea>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div>
                          ...
                          <textarea class="form-control" rows="2" name="external_support"><?php echo $data[0]['external_support'] ?></textarea>
