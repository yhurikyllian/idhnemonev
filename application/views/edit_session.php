            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                   ...
                   <?php echo form_open_multipart('edit/update_session/'.$data[0]['id_session'], 'class="form-horizontal form-label-left"');?>
                  ...
                  <div class="item form-group">
                    ...
                    <span class="section">Edit Session</span>

                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Session Title <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="email" name="session_title" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $data[0]['session_title'] ?>"> 
                      </div>
                    </div>

                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Type of Session<span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input value="<?php echo $data[0]['type_session'] ?>" type="text" id="email" name="session_type" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                        ...
                        <div class="control-group">
                          <div class="controls">
                            <div class="col-md-3 xdisplay_inputx form-group has-feedback">
                              <input type="text" class="form-control has-feedback-left" id="single_cal2" placeholder="First Name" aria-describedby="inputSuccess2Status" name="date">
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Time<span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input value="<?php echo $data[0]['session_time'] ?>" type="text" id="email" name="time" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>

                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Venue<span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input value="<?php echo $data[0]['session_venue'] ?>" type="text" id="email" name="venue" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>

                    <!-- <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Speaker(s) <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12" >
                      <select required="required" class="form-control js-example-basic-multiple" multiple="multiple" name="speaker[]" style="width:100%">
                        <?php 
                        $speaker = $this->m_db->getTabel('speaker','*');
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12" >
                      <select required="required" class="form-control"  name="speaker" style="width:100%">
                        <?php 
                        $speaker = $this->m_db->getTabel('speaker','*');
                        foreach($speaker as $d){
                        if($data[0]['id_speaker'] == $d['id_speaker']){
                        ?>
                          
                        <option selected><?php echo $d["name"]?></option>
                        <?php } else { ?>
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Moderator <span class="required"></span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12" >
                        <input value="<?php echo $data[0]['moderator'] ?>" type="text" class="form-control col-md-7 col-xs-12" name="moderator">
                      </div>
                    </div>

                     <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Doccument</span>
                      </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                        <div>

                          <input type="file" class="control-label" name="doccument[]" multiple="multiple"></textarea>
