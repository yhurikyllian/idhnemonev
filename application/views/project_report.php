          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <?php echo form_open_multipart('project_report/input', 'class="form-horizontal form-label-left"');?>
                  ...
                  <!-- <span class="section">Add Session</span> -->
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="email" name="result"  class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="email" name="reflection"  class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="email" name="follow"  class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
